...
('landlord','home.access'),('landlord','properties.access'),('landlord','properties.create'),('landlord','properties.edit'),('landlord','properties.archive'),('landlord','properties.restore'),('landlord','properties.manage_photos'),('landlord','tenants.access'),('landlord','tenants.create'),('landlord','tenants.edit'),('landlord','tenants.archive'),('landlord','tenants.restore'),('landlord','tenants.delete'),('landlord','leases.access'),('landlord','leases.create'),('landlord','leases.delete'),('landlord','leases.restore'),('landlord','tickets.access'),('landlord','tickets.create'),('landlord','tickets.assign'),('landlord','tickets.update_status'),('landlord','tickets.restore'),('landlord','tickets.comment'),('landlord','staff.access'),('landlord','staff.create'),('landlord','staff.edit'),('landlord','staff.archive'),('landlord','staff.restore'),('landlord','staff.delete'),('landlord','resources.access'),('landlord','resources.create'),('landlord','resources.edit'),('landlord','resources.delete'),('landlord','calendar.access'),('landlord','documents.access'),('landlord','documents.delete'),
('property_manager','home.access'),('property_manager','properties.access'),('property_manager','properties.create'),('property_manager','properties.edit'),('property_manager','properties.archive'),('property_manager','properties.manage_photos'),('property_manager','tenants.access'),('property_manager','tenants.create'),('property_manager','tenants.edit'),('property_manager','tenants.archive'),('property_manager','leases.access'),('property_manager','leases.create'),('property_manager','leases.delete'),('property_manager','tickets.access'),('property_manager','tickets.create'),('property_manager','tickets.assign'),('property_manager','tickets.update_status'),('property_manager','tickets.comment'),('property_manager','staff.access'),('property_manager','resources.access'),('property_manager','resources.create'),('property_manager','resources.edit'),('property_manager','resources.delete'),('property_manager','calendar.access'),('property_manager','documents.access'),
('maintenance','home.access'),('maintenance','tickets.access'),('maintenance','tickets.create'),('maintenance','tickets.assign'),('maintenance','tickets.update_status'),('maintenance','tickets.comment'),('maintenance','documents.access'),
('tenant','home.access'),('tenant','tickets.access'),('tenant','tickets.create'),('tenant','tickets.comment'),('tenant','resources.access'),('tenant','leases.access'),('tenant','documents.access');"
