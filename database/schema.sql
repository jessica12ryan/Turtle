...
INSERT IGNORE INTO settings (`key`, `value`) VALUES ('app_version', '1.0.4'), ('last_update_check', ''), ('latest_version', ''), ('update_channel', 'stable'), ('timezone', 'America/New_York'), ('ntp_server', 'time.gov'), ('last_ntp_check', ''), ('last_ntp_status', '');
