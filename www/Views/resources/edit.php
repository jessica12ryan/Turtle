<h1 class="text-2xl font-bold text-gray-800 mb-6">Edit Resource</h1>
<div class="bg-white rounded-lg shadow p-6 max-w-2xl">
    <form method="POST" action="/resources/<?= $link['id'] ?>/update">
        ...
        <div class="flex space-x-3">
            <button type="submit" class="bg-blue-600 text-white px-6 py-2 rounded-lg hover:bg-blue-700 font-medium">Update Resource</button>
