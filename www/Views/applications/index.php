                ...
                <?php foreach ($applications as $app): ?>
                    ...
                    <tr class="hover:bg-gray-50 dark:hover:bg-gray-700 <?= $app['archived_at'] ? 'opacity-60' : '' ?>">
                        ...
                        <td class="px-6 py-4">
                            ...
                            <span class="px-2 py-1 text-xs rounded-full <?= $status === 'new' ? 'bg-yellow-100 dark:bg-yellow-900 text-yellow-800 dark:text-yellow-200' : ($status === 'in_progress' ? 'bg-blue-100 dark:bg-blue-900 text-blue-800 dark:text-blue-200' : ($status === 'accepted' ? 'bg-green-100 dark:bg-green-900 text-green-800 dark:text-green-200' : ($status === 'rejected' ? 'bg-red-100 dark:bg-red-900 text-red-800 dark:text-red-200' : 'bg-gray-100 dark:bg-gray-700 text-gray-800 dark:text-gray-200'))) ?>">
