<div class="flex gap-6">
    ...
    <div class="w-56 flex-shrink-0">
        <div class="bg-white rounded-lg shadow divide-y">
            ...
            <a href="/settings?tab=notifications" class="flex items-center space-x-3 px-4 py-3 text-sm font-medium <?= $tab === 'notifications' ? 'bg-blue-50 text-blue-700' : 'text-gray-700 hover:bg-gray-50' ?>">
    ...
    <div class="flex-1 min-w-0">
        ...
        <?php elseif ($tab === 'notifications'): ?>
            <?php require base_path('www/Views/settings/partials/notifications.php'); ?>
