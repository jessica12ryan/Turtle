...
<div class="bg-white rounded-lg shadow p-6 max-w-2xl mb-6">
    <form method="POST" action="/properties/<?= $property['id'] ?>/update">
        ...
        <div class="mb-4">
            ...
            <input type="text" name="apt_suite" value="<?= h($property['apt_suite'] ?? '') ?>" class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-blue-500" placeholder="e.g., Apt 2B, Suite 300">
        </div>
