<form method="POST" action="/password/change">
    ...
    <p class="text-gray-600 mb-6 text-sm">You are required to change your password before continuing.</p>
    <div class="mb-4">
    ...
    <button type="submit" class="w-full bg-blue-600 text-white py-2.5 rounded-lg hover:bg-blue-700 font-medium">Change Password</button>
</form>
