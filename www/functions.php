...
function defaultPermissions(): array
{
    return [
        'landlord' => [
            ...
            'tickets.access', 'tickets.create', 'tickets.assign', 'tickets.update_status', 'tickets.archive', 'tickets.restore', 'tickets.comment', 'tickets.internal_comment',
        ...
        'property_manager' => [
            ...
            'tickets.access', 'tickets.create', 'tickets.assign', 'tickets.update_status', 'tickets.comment', 'tickets.internal_comment',
            'staff.access',
            'resources.access', 'resources.create', 'resources.edit', 'resources.delete',
            'calendar.access',
            'documents.download',
