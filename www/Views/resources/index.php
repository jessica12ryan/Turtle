...
<?php if (empty($generalLinks) && empty($staffLinks)): ?>
    <div class="text-center py-12 text-gray-500"><?= __('No resources added yet.') ?></div>
<?php else: ?>
    <?php if (!empty($generalLinks)): ?>
        <h2 class="text-lg font-semibold text-gray-700 mb-3"><?= __('General Resources') ?></h2>
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-8">
            <?php foreach ($generalLinks as $link): ?>
    ...
    <?php if (!empty($staffLinks) && $isStaff): ?>
        <h2 class="text-lg font-semibold text-gray-700 mb-3"><?= __('Staff Resources') ?></h2>
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-8">
