<div class="bg-white rounded-lg shadow p-6">
    ...
    <form method="POST" action="/settings/permissions">
        ...
        $permissionLabels = [
            ...
            'leases.access' => 'View Documents',
            'leases.create' => 'Create Documents',
            'leases.archive' => 'Archive Documents',
            'leases.restore' => 'Restore Documents',
            'leases.delete' => 'Delete Documents',
