...
('landlord','home.access'),('landlord','properties.access'),('landlord','properties.create'),('landlord','properties.edit'),('landlord','properties.archive'),('landlord','properties.restore'),('landlord','photos.create'),('landlord','photos.edit'),('landlord','photos.download'),('landlord','tenants.access'),('landlord','tenants.create'),('landlord','tenants.edit'),('landlord','tenants.archive'),('landlord','tenants.restore'),('landlord','leases.access'),('landlord','leases.create'),('landlord','leases.archive'),('landlord','leases.restore'),('landlord','tickets.access'),('landlord','tickets.create'),('landlord','tickets.assign'),('landlord','tickets.update_status'),('landlord','tickets.archive'),('landlord','tickets.restore'),('landlord','tickets.comment'),('landlord','staff.access'),('landlord','staff.create'),('landlord','staff.edit'),('landlord','staff.archive'),('landlord','staff.restore'),('landlord','resources.access'),('landlord','resources.create'),('landlord','resources.edit'),('landlord','calendar.access'),('landlord','documents.download'),
('property_manager','home.access'),('property_manager','properties.access'),('property_manager','properties.create'),('property_manager','properties.edit'),('property_manager','photos.create'),('property_manager','photos.edit'),('property_manager','photos.download'),('property_manager','tenants.access'),('property_manager','tenants.create'),('property_manager','tenants.edit'),('property_manager','leases.access'),('property_manager','leases.create'),('property_manager','tickets.access'),('property_manager','tickets.create'),('property_manager','tickets.assign'),('property_manager','tickets.update_status'),('property_manager','tickets.comment'),('property_manager','staff.access'),('property_manager','resources.access'),('property_manager','resources.create'),('property_manager','resources.edit'),('property_manager','calendar.access'),('property_manager','documents.download'),
